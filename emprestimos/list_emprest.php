...
if (!empty($busca)) {
    $condicoes[] = "(e.nome_aluno LIKE '%$busca%' OR l.titulo_livro LIKE '%$busca%')";
}
if ($turma_filtro > 0) {
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="9" class="text-center py-4 text-muted">Nenhum empréstimo encontrado para os
                        ...
                        <tr>
                            ...
                            <td class="fw-bold text-dark">
                                <span class="text-truncate-custom"
                                    title="<?= htmlspecialchars($row['titulo_livro']) ?>">
                            ...
                            <td class="text-center small">
                                <span class="text-truncate-custom" title="<?= htmlspecialchars($row['nome_user']) ?>">
                                    <?= htmlspecialchars($row['nome_user']) ?>
                                </span>
                            </td>
                            <td class="text-center">
                                <span class="badge <?= $badge_class ?> px-2 py-2 rounded-pill w-100"
                                    style="max-width: 95px; font-size: 0.75rem;">
                                    <?= $row['status'] ?>
                                </span>
                            </td>
                            <td class="text-center">
